...
func getNextVersion(v *string, curr int, len int) (int, int) {
	if curr >= len {
		return 0, curr
	}
	j := len
	...
	num, err := strconv.Atoi(string((*v)[curr:j]))
	if err != nil {
		return 0, j + 1
	}
	return num, j + 1
...
func compareVersion(version1 string, version2 string) int {
	...
	num1, num2 := 0, 0
	for p1 < n1 || p2 < n2 {
		num1, p1 = getNextVersion(&version1, p1, n1)
		num2, p2 = getNextVersion(&version2, p2, n2)
		if num1 > num2 {
			return 1
		} else if num1 < num2 {
			return -1
